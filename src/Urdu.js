...
import {available_now_urdu, interpreters_urdu} from './components/interpreter'
function Urdu() {
    return(
        <main className="main">
                    <div className="doctor">
                        <h2>List of Urdu interpreters</h2>

                        {interpreters_urdu.map((item) => {
                            return(
