...
import {available_now_hindi, interpreters, interpreters_hindi} from './components/interpreter'
function Hindi() {
    return(
        <main className="main">
                    <div className="doctor">
                        <h2>List of Hindi interpreters</h2>

                        {interpreters_hindi.map((item) => {
                            return(
