...
import {available_now_arabic, interpreters_arabic} from './components/interpreter'
function Arabic() {
        return(
            <main className="main">
                        <div className="doctor">
                            <h2>List of Arabic interpreters</h2>
    
                            {interpreters_arabic.map((item) => {
                                return(
